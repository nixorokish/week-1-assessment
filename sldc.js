...
var SDLC = [`Planning`, `Analysis of Requirements`, `Design`, `Implementation`, `Testing & Integration`, `Maintain`]
console.log(SDLC)
console.log(sep)
...
let plan = `This is the first step, in which the end goal of the software is determined and defined. Developers typically will see what systems are already in place, and determine what features will need to be added.` 
let analys = `The analysis phase answers the questions of who will use the system, what the system will do, and where and when it will be used.`
let design = `The design phase decides how the system will operate, in terms of the hardware, software, and network infrastructure; the user interface, forms and reports; and the specific programs, databases, and files that will be needed`
let impl =  `The phase in which the system is actually built (or purchased, in the case of a packaged software design). This is the phase that usually gets the most attention, because for most systems it is the longest and most expensive single part of the development process.`
